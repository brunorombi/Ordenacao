...
int main() {
    int *v, n, *v2, *v3, *v4;
    long long int trocas, comparacoes; // Alteração de int para long long int
    long int ini, fim;
    ...
    while (n > 0) {
        ...
        inverte(v, v4, n);
        //0exibe("Vetor aleatório invertido", v4, n);
        ...
        printf("\nForam realizadas %lld comparacoes e %lld trocas no vetor aleatório", comparacoes, trocas); // Alteração de %d para %lld
        ...
        printf("\nTempo para tamanho %d: %ld", n, fim - ini);
        printf("\nForam realizadas %lld comparacoes e %lld trocas no vetor quase ordenado", comparacoes, trocas); // Alteração de %d para %lld
        ...
        printf("\nTempo para tamanho %d: %ld", n, fim - ini);
        printf("\nForam realizadas %lld comparacoes e %lld trocas no vetor com repetições variadas", comparacoes, trocas); // Alteração de %d para %lld
        ...
        printf("\nTempo para tamanho %d: %ld", n, fim - ini);
        printf("\nForam realizadas %lld comparacoes e %lld trocas no vetor invertido",comparacoes,trocas); // Alteração de %d para %lld
